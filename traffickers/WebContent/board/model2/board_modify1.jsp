	...
	<input type ="hidden" name = "seq" value="<%=seq %>"/>
		<div class="contents_sub">	
			...
			<div class="board_write">
				...
				<tr>
					<th>내용</th>
					<td colspan="3"><textarea name="content" value="" class="board_editor_area"><%=content %></textarea></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td colspan="3"><input type="text" name="mail1" value="<%=mails[0] %>" class="board_view_input_mail"/> @ <input type="text" name="mail2" value="<%=mails[1] %>" class="board_view_input_mail"/></td>
				</tr>
				</table>
			</div>
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='view.do'">보기</button>
				</div>
